...
#
    if 'Example.mobileconfig' in os.listdir('.'):
        ...
        print "Printing Emaple.mobileconfig"
        print pl
...
class do_mdm:        
    def PUT(self):        
        ...
        print "Reading plist from String"
        print pl
        ...
        if pl.get('Status') == 'Idle':
            ...
            device_list[pl['UDID']].popCompletedCommand()
            ...
            print HIGH+" NotNow "+NORMAL
            rd = dict()            
            device_list[pl['UDID']].reverseCommand()
            
            store_devices()
            
        else:
            print "In the last else part"
            print "Message type"
            print pl.get('MessageType')
            rd = dict()
        ...
        print "do_mdm: RD Object"
        print rd
        out = writePlistToString(rd)
        print "do_mdm: Writing what is being set to device"
        print out
...
def do_TokenUpdate(pl):
    ...
    print "Device list before adding anything to device"
    print device_list
    print "Printing new tuple"
    print newTuple
